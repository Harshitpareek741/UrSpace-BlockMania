...
const GameBoard: React.FC<GameBoardProps> = ({ setIsCustomized }) => {
  ...
  const homePageApi = process.env.NEXT_PUBLIC_HOME_PAGE;
  return (
    <div className="absolute top-0 z-[-2] h-screen w-screen bg-neutral-950 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]">
      <canvas className="" id="canvas" ref={canvasRef}></canvas>
      ...
      <div
        className="absolute inset-0 -z-20 h-full w-full items-center px-5 py-24"
        style={{
