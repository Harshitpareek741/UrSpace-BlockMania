    ...
    <>
      <div>
        ...
        <div className="hidden md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col">
          ...
          <div className="flex min-h-0 flex-1 flex-col  bg-[radial-gradient(circle_400px_at_50%_300px,#fbfbfb36,#000)]">
            ...
            <div className="flex flex-shrink-0  bg-[radial-gradient(circle_400px_at_50%_300px,#fbfbfb36,#000)]  p-4">
              <div className="flex items-center">
                <div
                  style={bgColourPicker(
